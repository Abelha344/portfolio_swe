...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 w-full items-center justify-start gap-1 overflow-x-auto rounded-lg border border-border bg-muted/40 p-1 text-muted-foreground backdrop-blur-sm sm:w-auto",
      className
    )}
    {...props}
  />
